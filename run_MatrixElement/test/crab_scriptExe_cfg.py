...
config.General.requestName = 'run_MatrixElement_PROCESSNAME'
...
config.JobType.scriptArgs = ["numberOfEvents=NUMBEROFEVENTS","SampleName=PROCESSNAME"]
config.JobType.psetName = 'emptyPSet_PROCESSNAME_cfg.py'
