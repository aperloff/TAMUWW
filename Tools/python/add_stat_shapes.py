...
Edited By: Alexx Perloff, Texas A&M University
            ...
            if do_shapes:
                ...
                for ibin in range(minimum, th1.GetNbinsX()+1):
                    ...
                    if val:
                        ...
                        if error:
                            log.info("%s_%s_%s_bin_%i is zero, but will have a non-zero error.",
                                     prefix, suffix, histo, ibin)
                            above_threshold = True
                    ...
                    if above_threshold:
                        ...
                        if val < error:
                            log.warning("%s_%s_%s_bin_%iDown, is negative, pegged to zero", prefix, suffix, histo, ibin)
                        outputdir.cd()
                        err_up.Write()
                        err_down.Write()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--suffix', default='TwoJ0B',
                        help='Suffix for the systematic name,'
                        'fixme should be something like TwoJ0B, ThreeJ0B, etc')
